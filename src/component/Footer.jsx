      ...
      <div className="container mx-auto flex flex-col md:flex-row md:items-start justify-center md:justify-between px-4">
        ...
        <div className="mb-4 md:mb-0">
          ...
          <div className="flex items-center mb-2">
            ...
            <span>club.ojaswa@gmail.com</span>
          </div>
          <div className="flex items-center mb-2">
          <FontAwesomeIcon icon={faUser} className="mr-2" />
          <span>Aru Agrawal :</span>
            {/* <FontAwesomeIcon icon={faPhone} className="mr-2" /> */}
            <span>+91 79996 08275</span>
          </div>
          <div className="flex items-center mb-2">
          <FontAwesomeIcon icon={faUser} className="mr-2" />
          <span>Nitesh Gurjar :</span>
            {/* <FontAwesomeIcon icon={faPhone} className="mr-2" /> */}
            <span>+91 81099 03959</span>
          </div>
          <div className="flex items-center">
            <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2" />
            <span>Shri Govindram Seksaria Institute of Technology and Science, Indore, Madhya Pradesh, India</span>
          </div>
        ...
        {/* Center - Useful links */}
        <div className="mb-4 md:mb-0">
          <h4 className="text-lg mb-2">Useful Links</h4>
          <ul className="text-md">
            ...
            <li><a href="/team" className="text-gray-300 hover:text-white transition duration-300">Team</a></li>
            <li><a href="/sponsor" className="text-gray-300 hover:text-white transition duration-300">Sponsor</a></li>
